...
export function DestinationEditModal({ destination }) {
    const { _id, imageUrl, country, destinationName, price, duration, departureDate, description, category } = destination;
    ...
    return (
        <Modal>
            <Button variant='secondary' className='inline-flex items-center gap-2 rounded-none'><FaRegEdit /> Edit</Button>
            <Modal.Backdrop>
